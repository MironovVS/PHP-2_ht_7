...
{	
	...
	public function Login($login, $password, $remember = true)
	{
		...
		if ($this->sid) {
			setcookie('sid', $this->sid, time() + 60*20);
		}
	...
	{	
		...
		$query = sprintf($t, $this->msql->real_escape_string($login));
		//die(var_dump($query));
		$result = $this->msql->Select($query);
	...
	{	
		...
		$id_user=$this->msql->real_escape_string($id_user);
		$priv=$this->msql->real_escape_string($priv);
